...
namespace sound {
	...
	public:
		...
		inline void getPosition(irr::core::vector3df &position) { getPosition(position.X, position.Y, position.Z); }
		...
		virtual void getVelocity(irr::core::vector3df &velocity) { getVelocity(velocity.X, velocity.Y, velocity.Z); }
