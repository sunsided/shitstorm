...
namespace pv {
	...
	/** Diese Funktion dient zur Initialisierung von �berladenen Klassen */
	...
	void GameEngine::OnSetupScene() {
		...
		cube->setPosition(core::vector3df(0, 2.5, 2)); // TODO: �bernehmen lassen
	...
	*/
	...
	//! Handler f�r das Pause-Ereignis
	void GameEngine::OnPause() { 
		getTimer()->pause();
	}

	//! Handler f�r das Unpause-Ereignis
	...
	void GameEngine::OnSceneLoop(f32 elapsedTime) { 
		...
		// Distanz zur Mitte errechnen, dann Lautst�rke des Streaming-Emitters entsprechend einstellen
		...
		// Backbuffer als Ziel w�hlen und Hauptszene rendern
